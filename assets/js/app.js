/* =========================================================
   Guía Hermosa 7 · interacciones del cliente
   ========================================================= */
...
(() => {
  ...
  const I18N = {
    es: {
      ...
      'footer.sign': 'Hermosa 7 · Calle Hermosa · Granada',
  ...
  function applyLang(lang) {
    ...
    try { localStorage.setItem('hermosa7.lang', lang); } catch (_) {}
  }
  ...
  let savedLang = null;
  try { savedLang = localStorage.getItem('hermosa7.lang'); } catch (_) {}
